...
template<class State, class Addr_t, bool Energy>
typename CacheAssoc<State, Addr_t, Energy>::Line *CacheAssoc<State, Addr_t, Energy>::findPrevLinePrivate(Addr_t addr)
{
    Addr_t tag = calcTag(addr);
...
template<class State, class Addr_t, bool Energy>
typename CacheDM<State, Addr_t, Energy>::Line *CacheDM<State, Addr_t, Energy>::findPrevLinePrivate(Addr_t addr)
{
    Addr_t tag = calcTag(addr);
...
template<class State, class Addr_t, bool Energy>
typename CacheDMSkew<State, Addr_t, Energy>::Line *CacheDMSkew<State, Addr_t, Energy>::findPrevLinePrivate(Addr_t addr)
{
    Addr_t tag = calcTag(addr);
